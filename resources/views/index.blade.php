...
@section('content')
<!-- testimonial -->
    <div class="w-100 shadow-top">
    </div>
    <section class="container pt-4">
        <div class="row">
            <div class="col-md-4" title="Explora el Mundo con CaribeTour" style="background-image: url('{{ asset('images/explora.jpg') }}'); background-repeat: no-repeat; background-size: contain; background-position: center;"></div>

            <div class="col-md-12 col-lg-8">
                <h3 class="border-bottom">Explora el mundo con CaribeTour</h3>
                <div class="row">
    ...
    <div class="w-100 shadow-bottom">
    </div>
    <!-- /testimonial -->

    <!-- tour-list -->
    <section class="bg-palm pt-4 pb-4">
        <div class="container">
            <div class="row pt-4">
