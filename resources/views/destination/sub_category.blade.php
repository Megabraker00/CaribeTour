        ...
        <div class="featured-blog">
            <article class="post-112 post type-post status-publish format-standard hentry category-guides tag-amet tag-dolor tag-lorem post">
                <div class="featured-image">
                    <a hreflang="es" type="text/html" charset="iso-8859-1" href="{{ route('destinos') }}/{{ $category->fullSlug() }}">
                ...
                <div class="post-content">
                    <h2 class="post-title">
                        <a hreflang="es" type="text/html" charset="iso-8859-1" href="{{ route('destinos') }}/{{ $category->fullSlug() }}" title="{{ $category->name }}">{{ $category->name }} desde 631,40€</a>
                    </h2>
                </div>
            </article>
        </div>
